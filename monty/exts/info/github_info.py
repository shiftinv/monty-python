...
from monty.utils.services import GITHUB_REQUEST_HEADERS, GITHUB_REQUEST_HEADERS_MOBILE
...
class GithubInfo(commands.Cog, name="GitHub Information", slash_command_attrs={"dm_permission": False}):
    ...
    def __init__(self, bot: Monty) -> None:
        ...
        self.gql_mobile = self._create_gql_client(GITHUB_REQUEST_HEADERS_MOBILE)
        ...
        *,
        ...
        if is_discussion:
            ...
            if is_org_level:
                ...
                user = repository
                try:
                    json_data = await self.gql_mobile.execute_async(
